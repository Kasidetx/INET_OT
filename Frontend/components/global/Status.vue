<template>
  <v-chip small class="status-chip font-weight-bold px-3" :color="statusConfig.bg" :text-color="statusConfig.text"
    style="border-radius: 6px; border: 1px solid transparent;" :style="{ borderColor: statusConfig.border }">
